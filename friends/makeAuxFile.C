...
{ 
  ...
  string filename_out = outputDir + "my.aux.root";;
  ...
  float  genWeightSign;
  events_out->Branch("genWeightSign",&genWeightSign, "genWeightSign/F"); // jzb response corrected from TProfile
...
*/
     ...
     // setting variable to write
     if(genWeight_ > 0) genWeightSign = +1; else{genWeightSign = -1;}
...
void init()
{
    ...
    events_in->SetBranchAddress("genWeight"        ,&genWeight_             );
    ...
    events_in->SetBranchAddress("jetGenPt"         ,jetGenPt_               );

    events_in->SetBranchAddress("njetsFW"          ,&njetsFW_               );
    events_in->SetBranchAddress("jetFWPt"          ,jetFWPt_                );
    events_in->SetBranchAddress("jetFWEta"         ,jetFWEta_               );
    events_in->SetBranchAddress("jetFWPhi"         ,jetFWPhi_               );
    events_in->SetBranchAddress("jetFWM"           ,jetFWM_                 );
    events_in->SetBranchAddress("jetFWGenPt"       ,jetFWGenPt_             );
    ...
    events_in->SetBranchAddress("isData"             ,&isData_                  );

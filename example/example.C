...
void example()
{
  ...
  basicDataMCPlot("met_basic_SF", hs_data, hs_mc, true, "TR");
  ...
  basicDataMCPlot("l1l2M_basic_SF", hs_data, hs_mc, true, "TR");
  ...
  basicDataMCPlot("jzb_basic_SF", hs_data, hs_mc, true, "TL");
